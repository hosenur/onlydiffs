  ...
  return (
    <TabPrimitive
      ...
      className={cx(
        ...
        orientation === "horizontal"
          ? "first:-ms-(--tab-gutter) last:-me-(--tab-gutter) [--tab-gutter-x:--spacing(2.5)] [--tab-gutter-y:--spacing(1)]"
          ...
          {selectionIndicator && (
            <SelectionIndicator
              ...
              className={twMerge(
                ...
                orientation === "horizontal"
                  ? "-bottom-[calc(var(--tab-gutter-y)+1px)] inset-e-(--tab-gutter-x) start-(--tab-gutter-x) h-0.5 motion-safe:transition-[translate,width]"
