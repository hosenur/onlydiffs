...
const DialogCloseIcon = ({ className, ...props }: CloseButtonIndicatorProps) => {
  return props.isDismissable ? (
    <PrimitiveButton
      slot="close"
      className={cx(
        "close absolute end-1 top-1 z-50 grid size-8 place-content-center rounded-xl hover:bg-secondary/50 focus:outline-hidden focus-visible:ring-1 focus-visible:ring-primary sm:inset-e-2 sm:top-2 sm:size-7 sm:rounded-md",
        className,
      )}
    >
