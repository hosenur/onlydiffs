...
export function DisclosureIndicator({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={twMerge(
        "-me-[calc(var(--disclosure-gutter-x,--spacing(0))-(--spacing(2)))] pointer-events-none relative ms-(--disclosure-gutter-x,--spacing(0)) flex size-6 shrink-0 items-center justify-center [--width:--spacing(2.5)]",
        className,
      )}
      {...props}
    >
